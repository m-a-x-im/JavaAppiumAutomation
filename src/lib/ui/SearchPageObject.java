...
public class SearchPageObject extends MainPageObject {
    ...
    private static final String
            SKIP_ONBOARDING_ID = "id:org.wikipedia:id/fragment_onboarding_skip_button",
            SEARCH_INIT_ELEMENT_ID = "id:org.wikipedia:id/search_container",
            SEARCH_INPUT_ID = "id:org.wikipedia:id/search_src_text",
            SEARCH_CANCEL_ID = "id:org.wikipedia:id/search_close_btn",
            SEARCH_RESULTS_LIST_ID = "id:org.wikipedia:id/search_results_list",
            SEARCH_RESULT_WITH_DESCRIPTION_XPATH_TEMPLATE = "xpath://*[@resource-id='org.wikipedia:id" +
                    "/page_list_item_description'][@text='{DESCRIPTION}']",
            SEARCH_RESULT_WITH_TITLE_AND_DESCRIPTION_XPATH_TEMPLATE = "xpath://android.view.ViewGroup[android.widget.TextView" +
            "[contains(@text, '{TITLE}')] and android.widget.TextView[@text='{DESCRIPTION}']]",
            SEARCH_ARTICLE_TITLE_XPATH = "xpath://*[@resource-id='org.wikipedia:id/page_list_item_title']",
            LABEL_OF_EMPTY_SEARCH_RESULTS_XPATH = "xpath://*[@resource-id='org.wikipedia:id/results_text'][@text='No results']",
            ARTICLE_TOOLBAR_SEARCH_LINE_ID = "id:org.wikipedia:id/page_toolbar_button_search";
    ...
    public int getNumberOfArticlesFound() {
        this.waitForElementPresent(
                SEARCH_ARTICLE_TITLE_XPATH,
                "No Articles could be found using '" + SEARCH_ARTICLE_TITLE_XPATH + "'",
                5
        );
        return this.getNumberOfElements(SEARCH_ARTICLE_TITLE_XPATH);
    }
    ...
    public void waitForEmptyResultsLabel() {
        this.waitForElementPresent(
                LABEL_OF_EMPTY_SEARCH_RESULTS_XPATH,
    ...
    public List getSearchResultsList() {
        By locator = this.getLocatorByString(SEARCH_ARTICLE_TITLE_XPATH);
    ...
    public void typeArticleToolbarSearchLine(String query) {
        this.waitForElementAndClick(
                ARTICLE_TOOLBAR_SEARCH_LINE_ID,
